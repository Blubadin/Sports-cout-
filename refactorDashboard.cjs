...
const closingDiv = content.lastIndexOf('</div>', emptyStateStart); // The closing div for the grid grid-cols-1 lg:grid-cols-3

const charts = gridToPoints; // The 3 charts before points breakdown

const tail = content.substring(emptyStateStart); // Includes empty state and the rest of the component
