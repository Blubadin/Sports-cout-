    ...
    const handleKeyUp = (e: KeyboardEvent) => {
      ...
      if (isTargetKey && isKeyPressed.current) {
        ...
        if (currentHovered.current) {
          ...
          const value =
            currentHovered.current.getAttribute("data-scout-value") || "";
          ...
          if (group === "team") {
            ...
            const courtSide = currentHovered.current.getAttribute(
              "data-court-side",
            ) as "teamA" | "teamB" | "neutral" | undefined;
            onSelectArea(value, courtSide);
          } else if (group === "result") {
            onSelectResult(value);
          } else if (group === "descriptor") {
            const descGroup =
              currentHovered.current.getAttribute("data-descriptor-group") ||
              "";
