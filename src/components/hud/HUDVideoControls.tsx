        ...
        <div className="flex items-center justify-between relative">
          ...
          {isMobile && !showMore ? (
            ...
            <div className="flex items-center justify-center gap-4 flex-1">
              <button
                ...
                className="p-2 rounded-full bg-white/10 hover:bg-white/20 active:scale-95 active:bg-white/30 text-white transition-all flex items-center justify-center"
                title="-3s (A)"
              >
              ...
              <button
                ...
                className="p-3 rounded-full bg-sky-600 hover:bg-sky-500 active:bg-sky-700 text-white shadow-[0_0_10px_rgba(56,189,248,0.4)] transition-all transform active:scale-95 flex items-center justify-center"
            ...
            <div className="flex items-center justify-center gap-1.5 sm:gap-3 flex-1 flex-wrap">
              ...
              <button
                ...
                className="p-1 px-2 rounded-md bg-white/5 hover:bg-white/10 active:scale-95 active:bg-white/20 text-[10px] text-white/80 font-mono transition-colors flex items-center justify-center"
                title="-0.1s"
              >
                -0.1s
              </button>
              <button
                ...
                className="p-1.5 rounded-full bg-white/5 hover:bg-white/10 active:scale-95 active:bg-white/20 text-white transition-colors flex items-center justify-center"
                title="-1s (S)"
              >
                <SkipBack size={14} />
              </button>
              ...
              <button
                ...
                className="p-2 sm:p-2.5 rounded-full bg-white/10 hover:bg-white/20 active:scale-95 active:bg-white/30 text-white transition-colors flex items-center justify-center"
                title="-3s (A)"
              >
                <Rewind size={16} />
              </button>
              ...
              <button
                ...
                className="p-3 sm:p-3.5 rounded-full bg-sky-600 hover:bg-sky-500 active:bg-sky-700 text-white shadow-[0_0_12px_rgba(56,189,248,0.4)] transition-all transform active:scale-95 flex items-center justify-center"
                title="Play/Pause (Space)"
              >
          ...
          <div className="flex items-center justify-end gap-1.5 min-w-[70px] relative">
            ...
            <button
              ...
              className="flex items-center justify-center gap-1 px-2 py-1 rounded bg-white/10 hover:bg-white/20 active:scale-95 active:bg-white/30 text-[10px] sm:text-xs font-mono font-bold text-white/80 transition-colors"
            >
              {playbackRate}x
            </button>
              ...
              <div className="absolute bottom-full right-0 mb-2 bg-black/90 backdrop-blur-md border border-white/15 rounded-lg p-1 flex flex-col shadow-xl z-50 min-w-[70px]">
                {speeds.map((s) => (
                  <button
                    ...
                    className={`px-3 py-1.5 text-left text-[10px] font-mono rounded transition-colors ${playbackRate === s ? "bg-sky-600 text-white" : "text-white/70 hover:bg-white/10 active:bg-white/20"}`}
                  >
                    {s}x
                  </button>
                ))}
            ...
            {isMobile && (
              <button
                ...
                className="p-2 rounded-full bg-white/10 text-white hover:bg-white/20 active:scale-95 active:bg-white/30 transition-all flex items-center justify-center"
              >
