...
code = code.replace(
  `{ id: '3', code: '0', score: 0, thaiName: '0 (กลาง)' },
    ],
  },`,
  `{ id: '3', code: '0', score: 0, thaiName: '0 (กลาง)' },
    ],` + vbFouls
...
code = code.replace(
  `{ id: '4', code: 'Pass', score: 0, thaiName: 'ส่งบอล' },
    ],
  },`,
  `{ id: '4', code: 'Pass', score: 0, thaiName: 'ส่งบอล' },
    ],` + fbFouls
...
code = code.replace(
  `{ id: '3', code: '0', score: 0, thaiName: 'รับได้' },
    ],
  },`,
  `{ id: '3', code: '0', score: 0, thaiName: 'รับได้' },
    ],` + bdFouls
...
code = code.replace(
  `{ id: '4', code: '0', score: 0, thaiName: 'ส่งบอล/รับบอล' },
    ]
  }
};`,
  `{ id: '4', code: '0', score: 0, thaiName: 'ส่งบอล/รับบอล' },
